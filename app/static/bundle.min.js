...
var DealOrderEngine = React.forwardRef(function DealOrderEngine(props, ref) {
    ...
    if (['2', '3', '4', '5', '6'].indexOf(rank) !== -1)
    return 1;
    if (['7', '8', '9'].indexOf(rank) !== -1)
    return 0;
    return -1;
    }
...
class ErrorBoundary extends React.Component {
    ...
    React.createElement("div", { style: { background: '#1c2540', padding: 16, borderRadius: 8, marginBottom: 16, border: '1px solid rgba(255,92,92,0.4)', color: '#ff9a9a', fontSize: 14, lineHeight: 1.7 } }, this.state.error),
...
function App() {
    ...
    dealOrderEnabled && (React.createElement(DealOrderEngine, { ref: dealOrderRef, count: count, shoe: shoe })),
    ...
    React.createElement(CardGrid, { target: dealTarget, onTargetChange: setTarget, remainingByRank: shoe === null || shoe === void 0 ? void 0 : shoe.remaining_by_rank, onDealCard: handleDealCardWrapped, onUndo: handleUndo, onSplit: handleSplit, canSplit: !!((playerHand === null || playerHand === void 0 ? void 0 : playerHand.can_split) && splitHands.length === 0), dealerMustDraw: dealerMustDraw, dealerStands: dealerStandsFlag, scanMode: scanMode }),
