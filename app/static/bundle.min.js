...
function StopAlerts({ session, currency, socket }) {
    ...
    React.createElement("span", { style: { fontSize: 18, lineHeight: 1 } }, lossHit ? '❌' : winHit ? '🏆' : '✅'),
    React.createElement("div", null,
    React.createElement("div", { style: {
    fontSize: 11, fontWeight: 800,
    ...
    : 'Continue Playing'),
    React.createElement("div", { style: { fontSize: 9, color: '#94a7c4', marginTop: 1 } }, lossHit
    ...
    }, "aria-label": "Save limits", style: { flex: 2, padding: '5px', fontSize: 9, borderRadius: 5, cursor: 'pointer',
