...
function App() {
    ...
    React.createElement(CardGrid, { target: dealTarget, onTargetChange: setTarget, remainingByRank: shoe === null || shoe === void 0 ? void 0 : shoe.remaining_by_rank, onDealCard: handleDealCard, onUndo: handleUndo, onSplit: handleSplit, canSplit: !!((playerHand === null || playerHand === void 0 ? void 0 : playerHand.can_split) && splitHands.length === 0), dealerMustDraw: dealerMustDraw, dealerStands: dealerStandsFlag, scanMode: scanMode }),
