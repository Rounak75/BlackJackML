...
function TopBar({ count, onNewHand, onShuffle, onChangeSystem }) {
    ...
    React.createElement(CountBlock, { label: "RC", title: "Running Count: raw sum of all card tags seen (+1 low, \u22121 high)", value: rc, colorVal: rc, mono: true, secondary: true }),
    React.createElement("div", { style: { height: 1, background: 'rgba(255,255,255,0.07)' } }),
    React.createElement(CountBlock, { label: "ML", title: "ML-enhanced true count: adjusts for shuffle patterns tracked by LSTM model", value: etc.toFixed(1), colorVal: etc, mono: true, secondary: true })),
    React.createElement("div", { style: { width: 1, alignSelf: 'stretch', background: 'rgba(255,255,255,0.12)' } }),
    React.createElement("div", { className: "flex flex-col items-center justify-center", style: { padding: '10px 28px' }, title: "True Count: Running Count \u00F7 Decks Remaining. Use this for all strategy decisions." },
    React.createElement("div", { style: {
    fontSize: '0.65rem', textTransform: 'uppercase',
    letterSpacing: '0.12em', fontWeight: 700,
    color: '#b8ccdf', marginBottom: 4,
    } }, "True Count"),
    React.createElement("div", { className: `font-mono font-bold leading-none ${countClass(tc)}`, style: { fontSize: '2.4rem' } }, tc.toFixed(1))),
    React.createElement("div", { style: { width: 1, alignSelf: 'stretch', background: 'rgba(255,255,255,0.12)' } }),
    React.createElement("div", { style: {
    padding: '6px 16px',
    background: 'rgba(255,255,255,0.03)',
...
function ActionPanel({ recommendation, count, mlModelInfo }) {
    ...
    var modelBadgeColor = modelLoaded ? '#44e882' : '#94a7c4';
    var modelBadgeBg = modelLoaded ? 'rgba(68,232,130,0.10)' : 'rgba(148,167,196,0.10)';
    var modelBadgeText = modelLoaded
    ...
    React.createElement("span", { style: { width: 6, height: 6, borderRadius: '50%', background: modelBadgeColor, flexShrink: 0 } }),
    modelBadgeText),
...
function BettingPanel({ betting, count, lastBet, onRecordResult, currency, onCurrencyChange, customBet, onCustomBetChange, playerHand, dealerHand, insurance, isDoubled, onIsDoubledChange, tookInsurance, onTookInsuranceChange, }) {
    ...
    var session = (_b = betting === null || betting === void 0 ? void 0 : betting.total_profit) !== null && _b !== void 0 ? _b : 0;
...
function CenterToolbar({ recommendation, count, playerHand, dealerUpcard, betting, session, currency, sideCounts, casinoRisk }) {
    ...
    var tc = (_a = count === null || count === void 0 ? void 0 : count.true) !== null && _a !== void 0 ? _a : 0;
    var adv = (_b = count === null || count === void 0 ? void 0 : count.advantage) !== null && _b !== void 0 ? _b : 0;
    var decks = (_c = count === null || count === void 0 ? void 0 : count.decks_remaining) !== null && _c !== void 0 ? _c : '—';
    var pv = (_d = playerHand === null || playerHand === void 0 ? void 0 : playerHand.value) !== null && _d !== void 0 ? _d : 0;
    ...
    var hasCards = ((_f = (_e = playerHand === null || playerHand === void 0 ? void 0 : playerHand.cards) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0) >= 1;
    var profit = (_g = session === null || session === void 0 ? void 0 : session.total_profit) !== null && _g !== void 0 ? _g : 0;
    var hands = (_h = session === null || session === void 0 ? void 0 : session.hands_played) !== null && _h !== void 0 ? _h : 0;
    var sym = (_j = currency === null || currency === void 0 ? void 0 : currency.symbol) !== null && _j !== void 0 ? _j : '₹';
    var adjTC = (_k = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.ace_adjusted_tc) !== null && _k !== void 0 ? _k : tc;
    var aceRem = (_l = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.aces_remaining) !== null && _l !== void 0 ? _l : null;
    var aceExp = (_m = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.aces_expected) !== null && _m !== void 0 ? _m : null;
    var aceRich = (_o = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.ace_rich) !== null && _o !== void 0 ? _o : false;
    var aceAdj = (_p = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.ace_adjustment) !== null && _p !== void 0 ? _p : 0;
    var acesSeen = (_q = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.aces_seen) !== null && _q !== void 0 ? _q : 0;
    var tenRem = (_r = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.tens_remaining) !== null && _r !== void 0 ? _r : null;
    var tenExp = (_s = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.tens_expected) !== null && _s !== void 0 ? _s : null;
    var tenRich = (_t = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.ten_rich) !== null && _t !== void 0 ? _t : false;
    var tenAdj = (_u = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.ten_adjustment) !== null && _u !== void 0 ? _u : 0;
    var tensSeen = (_v = sideCounts === null || sideCounts === void 0 ? void 0 : sideCounts.tens_seen) !== null && _v !== void 0 ? _v : 0;
    var totalAces = aceRem !== null ? aceRem + acesSeen : 32;
    var totalTens = tenRem !== null ? tenRem + tensSeen : 128;
    var riskLevel = (_w = casinoRisk === null || casinoRisk === void 0 ? void 0 : casinoRisk.level) !== null && _w !== void 0 ? _w : 0;
    var riskLabel = (_x = casinoRisk === null || casinoRisk === void 0 ? void 0 : casinoRisk.label) !== null && _x !== void 0 ? _x : 'LOW';
    var riskColor = (_y = casinoRisk === null || casinoRisk === void 0 ? void 0 : casinoRisk.color) !== null && _y !== void 0 ? _y : '#44e882';
    var riskScore = (_z = casinoRisk === null || casinoRisk === void 0 ? void 0 : casinoRisk.score) !== null && _z !== void 0 ? _z : 0;
    var riskAdvice = (_0 = casinoRisk === null || casinoRisk === void 0 ? void 0 : casinoRisk.advice) !== null && _0 !== void 0 ? _0 : '';
    var spread = (casinoRisk === null || casinoRisk === void 0 ? void 0 : casinoRisk.spread) != null ? casinoRisk.spread : 1;
    var upRank = dealerUpcard ? String(dealerUpcard).replace(/[♠♥♦♣]/g, '').trim().toUpperCase() : null;
    var dealerBustPct = upRank ? ((_1 = DEALER_BUST_PCT[upRank]) !== null && _1 !== void 0 ? _1 : null) : null;
    var bustPct = (() => {
    ...
    var tcColor = tc >= 3 ? '#44e882' : tc >= 1 ? '#88eebb' : tc >= -1 ? '#b8ccdf' : '#ff5c5c';
    var adjTcColor = adjTC >= 3 ? '#44e882' : adjTC >= 1 ? '#88eebb' : adjTC >= -1 ? '#b8ccdf' : '#ff5c5c';
    var advCol = adv >= 0 ? '#44e882' : '#ff5c5c';
    ...
    var aceColor = aceAdj > 0.2 ? '#44e882' : aceAdj < -0.2 ? '#ff5c5c' : '#b8ccdf';
    var tenColor = tenAdj > 0.2 ? '#44e882' : tenAdj < -0.2 ? '#ff5c5c' : '#b8ccdf';
    var cell = (label, value, color, extra) => (React.createElement("div", { style: { textAlign: 'center', flex: 1 } },
    ...
    var sectionLabel = (text) => (React.createElement("div", { style: { fontSize: 9, color: '#ccdaec', textTransform: 'uppercase', letterSpacing: '0.07em',
...
function StopAlerts({ session, currency, socket }) {
    ...
    var lossFill = Math.min(1, Math.max(0, (profit - stopLoss) / lossRange));
    var winFill = Math.min(1, Math.max(0, profit / winRange));
    return (React.createElement("div", { style: shellStyle },
    ...
    React.createElement("button", { onClick: () => setEditing(false), style: {
...
function App() {
    ...
    dealTargetRef.current = 'player';
    setDealTarget('player');
    (_e = socketRef.current) === null || _e === void 0 ? void 0 : _e.emit('new_hand');
    replay.forEach((c, i) => {
    setTimeout(() => {
    var _a;
    ...
    React.createElement(ActionPanel, { recommendation: rec, count: count, mlModelInfo: gameState === null || gameState === void 0 ? void 0 : gameState.ml_model_info }),
    React.createElement(CompDepAlert, { recommendation: rec, trueCount: count === null || count === void 0 ? void 0 : count.true }),
    ...
    React.createElement(AccordionPanel, { label: "Ace & Ten Side Counts" },
    React.createElement(SideCountPanel, { sideCounts: sideCounts, count: count })),
    React.createElement(AccordionPanel, { label: "Session Analytics" },
