...
// ══════════════════════════════════════════════════════════════════════════════
// §8 — ERROR BOUNDARY — extracted to ErrorBoundary.js (Phase 7 T2)
// ══════════════════════════════════════════════════════════════════════════════
// The error boundary now lives in components/ErrorBoundary.js so it ships
// in production builds (where DebugLayer is excluded by build flag).
