 ...
 * ─────────────────────────────────────────────────────────
 * Static lookup data: card ranks, suits, strategy tables,
 * and the Illustrious 18 + Fab 4 deviation list.
 *
 * Loaded first — all other components depend on this data.
 */
...
// Hi-Lo count tags per rank: +1 low, -1 high, 0 neutral
const HILO_TAG = {
...
const HARD_TABLE = {
  ...
  15: ['S','S','S','S','S','H','H','H','SUR','SUR'],  // SUR vs 10,A (S17 8-deck)
  16: ['S','S','S','S','S','H','H','SUR','SUR','SUR'],  // SUR vs 9,10,A (S17 8-deck)
...
const PAIR_TABLE = {
  // No Double After Split (DAS=false): Y/N entries become H
